        ...
        Private Sub view_CustomDrawCell(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs)
            ...
            If currentInfo IsNot Nothing Then
                ...
                If currentInfo IsNot Nothing Then
                    ...
                    clipBoundsX = If(CInt((currentClip.X)) < e.Bounds.X, e.Bounds.X - 4, CInt((currentClip.X)))

                    If View.LeftCoord > 0 Then
                        e.Cache.ClipInfo.SetClip(New Rectangle(clipBoundsX, CInt((currentClip.Y)), textRect.Width, CInt(currentClip.Height)))
                    End If
                ...
                e.Handled = True
                e.Cache.ClipInfo.SetClip(New Rectangle(CInt((currentClip.X)), CInt((currentClip.Y)), CInt(currentClip.Width), CInt(currentClip.Height)))
            End If
        End Sub
    End Class
